    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="61">
            <div class="product__image" style="background-image: url('../../img/test1_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">test1</p>
                <div class="product__specs__info">
                    ...
                    <div class="product__specs__price">
                      <p class="product__specs__price--price">12 zł</p>
                      <div class="number">
